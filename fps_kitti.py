...
if __name__ == '__main__':
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph, config=config) as sess:
            ...
            init.camera_resolution = sl.PyRESOLUTION.PyRESOLUTION_HD1080   #'PyRESOLUTION_HD1080', 'PyRESOLUTION_HD2K', 'PyRESOLUTION_HD720', 'PyRESOLUTION_LAST', 'PyRESOLUTION_VGA'
...
#video_capture.release()
            t2 = cv2.getTickCount()
            print((1000/((t2 - t1)/cv2.getTickFrequency())))
print("end")
